...
class ProfilsFourn
{
    ...
    /**
     * @var \RocEclercBundle\Entity\ProfilsUsers
     *
     * @ORM\ManyToOne(targetEntity="RocEclercBundle\Entity\ProfilsUsers")
     * @ORM\JoinColumns({
     ...
     * Set pu
     *
     * @param \RocEclercBundle\Entity\ProfilsUsers $pu
     *
     * @return ProfilsFourn
     */
    public function setPu(\RocEclercBundle\Entity\ProfilsUsers $pu = null)
    {
        $this->pu = $pu;
     ...
     * Get pu
     *
     * @return \RocEclercBundle\Entity\ProfilsUsers
     */
