...
class ContratsCat
{
    ...
    /**
     * @var \RocEclercBundle\Entity\Societes
     *
     * @ORM\ManyToOne(targetEntity="RocEclercBundle\Entity\Societes")
     * @ORM\JoinColumns({
     ...
     * Set so
     *
     * @param \RocEclercBundle\Entity\Societes $so
     *
     * @return ContratsCat
     */
    public function setSo(\RocEclercBundle\Entity\Societes $so = null)
    {
        $this->so = $so;
     ...
     * Get so
     *
     * @return \RocEclercBundle\Entity\Societes
     */
