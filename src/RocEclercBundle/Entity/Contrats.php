...
class Contrats
{
    ...
    /**
     * @var \RocEclercBundle\Entity\ContratsCat
     *
     * @ORM\ManyToOne(targetEntity="RocEclercBundle\Entity\ContratsCat")
     * @ORM\JoinColumns({
     ...
     * Set coCategorie
     *
     * @param \RocEclercBundle\Entity\ContratsCat $coCategorie
     *
     * @return Contrats
     */
    public function setCoCategorie(\RocEclercBundle\Entity\ContratsCat $coCategorie = null)
    {
     ...
     * Get coCategorie
     *
     * @return \RocEclercBundle\Entity\ContratsCat
     */
