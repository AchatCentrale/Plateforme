...
class UsersDroits
{
    ...
    /**
     * @var \RocEclercBundle\Entity\Users
     *
     * @ORM\ManyToOne(targetEntity="RocEclercBundle\Entity\Users")
     * @ORM\JoinColumns({
     ...
     * Set us
     *
     * @param \RocEclercBundle\Entity\Users $us
     *
     * @return UsersDroits
     */
    public function setUs(\RocEclercBundle\Entity\Users $us = null)
    {
        $this->us = $us;
     ...
     * Get us
     *
     * @return \RocEclercBundle\Entity\Users
     */
