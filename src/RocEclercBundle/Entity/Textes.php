...
class Textes
{
    ...
    /**
     * @var \RocEclercBundle\Entity\Categories
     *
     * @ORM\ManyToOne(targetEntity="RocEclercBundle\Entity\Categories")
     * @ORM\JoinColumns({
     ...
     * Set catid
     *
     * @param \RocEclercBundle\Entity\Categories $catid
     *
     * @return Textes
     */
    public function setCatid(\RocEclercBundle\Entity\Categories $catid = null)
    {
        $this->catid = $catid;
     ...
     * Get catid
     *
     * @return \RocEclercBundle\Entity\Categories
     */
