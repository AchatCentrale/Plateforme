...
class CommandeDetail
{
    ...
    /**
     * @var \FunecapBundle\Entity\CommandeEntete
     *
     * @ORM\ManyToOne(targetEntity="FunecapBundle\Entity\CommandeEntete")
     * @ORM\JoinColumns({
     ...
     * Set ce
     *
     * @param \FunecapBundle\Entity\CommandeEntete $ce
     *
     * @return CommandeDetail
     */
    public function setCe(\FunecapBundle\Entity\CommandeEntete $ce = null)
    {
        $this->ce = $ce;
     ...
     * Get ce
     *
     * @return \FunecapBundle\Entity\CommandeEntete
     */
