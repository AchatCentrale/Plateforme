...
class FournisseurController extends Controller
{
    ...
    public function importProductsAction(Request $request)
    {
        ...
        for ($i = 1; $i < count($data); $i++){
            ...
            $filtre2 = empty($ligne[6]) ? " " : utf8_encode($ligne[6]);
            $valeur2 = empty($ligne[7]) ? " " : utf8_encode($ligne[7]);
            $filtre3 = empty($ligne[8]) ? " " : utf8_encode($ligne[8]);
            $valeur3 = empty($ligne[9]) ? " " : utf8_encode($ligne[9]);
            $filtre4 = empty($ligne[10]) ? " " : utf8_encode($ligne[10]);
            $valeur4 = empty($ligne[11]) ? " " : utf8_encode($ligne[11]);
            $filtre5 = empty($ligne[12]) ? " " : utf8_encode($ligne[12]);
            $valeur5 = empty($ligne[13]) ? " " : utf8_encode($ligne[13]);
            $filtre6 = empty($ligne[14]) ? " " : utf8_encode($ligne[14]);
            $valeur6 = empty($ligne[15]) ? " " : utf8_encode($ligne[15]);
            $filtre7 = empty($ligne[16]) ? " " : utf8_encode($ligne[16]);
            $valeur7 = empty($ligne[17]) ? " " : utf8_encode($ligne[17]);
            $filtre8 = empty($ligne[18]) ? " " : utf8_encode($ligne[18]);
            $valeur8 = empty($ligne[19]) ? " " : utf8_encode($ligne[19]);
            $filtre9 = empty($ligne[20]) ? " " : utf8_encode($ligne[20]);
            $valeur9 = empty($ligne[21]) ? " " : utf8_encode($ligne[21]);
            $filtre10 = empty($ligne[22]) ? " " : utf8_encode($ligne[22]);
            $valeur10 = empty($ligne[23]) ? " " : utf8_encode($ligne[23]);
            $type_produit = empty($ligne[24]) ? " " : utf8_encode($ligne[24]);
            $ref_parent = empty($ligne[25]) ? " " : utf8_encode($ligne[25]);
            $code_maitre = empty($ligne[26]) ? " " : utf8_encode($ligne[26]);
            $vte_addi = empty($ligne[27]) ? " " : utf8_encode($ligne[27]);
            $ref_fourn = empty($ligne[28]) ? " " : utf8_encode($ligne[28]);
            $ref_ac = empty($ligne[29]) ? " " : utf8_encode($ligne[29]);
            $ean = empty($ligne[30]) ? " " : utf8_encode($ligne[30]);
            $produit = empty($ligne[31]) ? " " : utf8_encode($ligne[31]);
            $descr_courte = empty($ligne[32]) ? " " : utf8_encode($ligne[32]);
            $descr_longue = empty($ligne[33]) ? " " : utf8_encode($ligne[33]);
            $detail_prod = empty($ligne[34]) ? " " : utf8_encode($ligne[34]);
            $info_frs = empty($ligne[35]) ? " " : utf8_encode($ligne[35]);
            $type_lien = empty($ligne[36]) ? " " : utf8_encode($ligne[36]);
            $lien = empty($ligne[37]) ? " " : utf8_encode($ligne[37]);
            $triptyque = empty($ligne[38]) ? " " : utf8_encode($ligne[38]);
            $quantite = empty($ligne[39]) ? " " : utf8_encode($ligne[39]);
            $conditionnement = empty($ligne[40]) ? " " : utf8_encode($ligne[40]);
            $delai_livraison = empty($ligne[41]) ? " " : utf8_encode($ligne[41]);
            $no_serie = empty($ligne[42]) ? " " : utf8_encode($ligne[42]);
            $prix_net = empty($ligne[43]) ? " " : utf8_encode($ligne[43]);
            $prix_public = empty($ligne[44]) ? " " : utf8_encode($ligne[44]);
            $prix_ca_1 = empty($ligne[45]) ? " " : utf8_encode($ligne[45]);
            $prix_vc_1 = empty($ligne[46]) ? " " : utf8_encode($ligne[46]);
            $prix_ca_2 = empty($ligne[47]) ? " " : utf8_encode($ligne[47]);
            $prix_vc_2 = empty($ligne[48]) ? " " : utf8_encode($ligne[48]);
            $prix_ca_3 = empty($ligne[49]) ? " " : utf8_encode($ligne[49]);
            $prix_vc_3 = empty($ligne[50]) ? " " : utf8_encode($ligne[50]);
            $prix_ca_4 = empty($ligne[51]) ? " " : utf8_encode($ligne[51]);
            $prix_vc_4 = empty($ligne[52]) ? " " : utf8_encode($ligne[52]);
            $prix_ca_5 = empty($ligne[53]) ? " " : utf8_encode($ligne[53]);
            $prix_vc_5 = empty($ligne[54]) ? " " : utf8_encode($ligne[54]);
            $degres_qte_1 = empty($ligne[55]) ? " " : utf8_encode($ligne[55]);
            $degres_prix_1 = empty($ligne[56]) ? " " : utf8_encode($ligne[56]);
            $degres_qte_2 = empty($ligne[57]) ? " " : utf8_encode($ligne[57]);
            $degres_prix_2 = empty($ligne[58]) ? " " : utf8_encode($ligne[58]);
            $degres_qte_3 = empty($ligne[59]) ? " " : utf8_encode($ligne[59]);
            $degres_prix_3 = empty($ligne[60]) ? " " : utf8_encode($ligne[60]);
            $degres_qte_4 = empty($ligne[61]) ? " " : utf8_encode($ligne[61]);
            $degres_prix_4 = empty($ligne[62]) ? " " : utf8_encode($ligne[62]);
            $degres_qte_5 = empty($ligne[63]) ? " " : utf8_encode($ligne[63]);
            $degres_prix_5 = empty($ligne[64]) ? " " : utf8_encode($ligne[64]);
            $degres_qte_6 = empty($ligne[65]) ? " " : utf8_encode($ligne[65]);
            $degres_prix_6 = empty($ligne[66]) ? " " : utf8_encode($ligne[66]);
            $degres_qte_7 = empty($ligne[67]) ? " " : utf8_encode($ligne[67]);
            $degres_prix_7 = empty($ligne[68]) ? " " : utf8_encode($ligne[68]);
            $degres_qte_8 = empty($ligne[69]) ? " " : utf8_encode($ligne[69]);
            $degres_prix_8 = empty($ligne[70]) ? " " : utf8_encode($ligne[70]);
            $degres_qte_9 = empty($ligne[71]) ? " " : utf8_encode($ligne[71]);
            $degres_prix_9 = empty($ligne[72]) ? " " : utf8_encode($ligne[72]);
            $degres_qte_10 = empty($ligne[73]) ? " " : utf8_encode($ligne[73]);
            $degres_prix_10 = empty($ligne[74]) ? " " : utf8_encode($ligne[74]);
            $remise = empty($ligne[75]) ? " " : utf8_encode($ligne[75]);
            $photo = empty($ligne[76]) ? " " : utf8_encode($ligne[76]);
            $photo_2 = empty($ligne[77]) ? " " : utf8_encode($ligne[77]);
            $photo_3 = empty($ligne[78]) ? " " : utf8_encode($ligne[78]);
            $pdf_txt_1 = empty($ligne[79]) ? " " : utf8_encode($ligne[79]);
            $pdf_lien_1 = empty($ligne[80]) ? " " : utf8_encode($ligne[80]);
            $pdf_txt_2 = empty($ligne[81]) ? " " : utf8_encode($ligne[81]);
            $pdf_lien_2 = empty($ligne[82]) ? " " : utf8_encode($ligne[82]);
            $pdf_txt_3 = empty($ligne[83]) ? " " : utf8_encode($ligne[83]);
            $pdf_lien_3 = empty($ligne[84]) ? " " : utf8_encode($ligne[84]);
