...
class FournisseurController extends Controller
{
    ...
    public function importProductsAction(Request $request)
    {
        ...
        for ($i = 1; $i < count($data); $i++){
            ...
            $famille = empty($ligne[3]) ? " " : $ligne[3];
            $filtre1 = empty($ligne[4]) ? " " : $ligne[4];
            $valeur1 = empty($ligne[5]) ? " " : $ligne[5];
            $filtre2 = empty($ligne[6]) ? " " : $ligne[6];
            $valeur2 = empty($ligne[7]) ? " " : $ligne[7];
            $filtre3 = empty($ligne[8]) ? " " : $ligne[8];
            $valeur3 = empty($ligne[9]) ? " " : $ligne[9];
            $filtre4 = empty($ligne[10]) ? " " : $ligne[10];
            $valeur4 = empty($ligne[11]) ? " " : $ligne[11];
            $filtre5 = empty($ligne[12]) ? " " : $ligne[12];
            $valeur5 = empty($ligne[13]) ? " " : $ligne[13];
            $filtre6 = empty($ligne[14]) ? " " : $ligne[14];
            $valeur6 = empty($ligne[15]) ? " " : $ligne[15];
            $filtre7 = empty($ligne[16]) ? " " : $ligne[16];
            $valeur7 = empty($ligne[17]) ? " " : $ligne[17];
            $filtre8 = empty($ligne[18]) ? " " : $ligne[18];
            $valeur8 = empty($ligne[19]) ? " " : $ligne[19];
            $filtre9 = empty($ligne[20]) ? " " : $ligne[20];
            $valeur9 = empty($ligne[21]) ? " " : $ligne[21];
            $filtre10 = empty($ligne[22]) ? " " : $ligne[22];
            $valeur10 = empty($ligne[23]) ? " " : $ligne[23];
            $type_produit = empty($ligne[24]) ? " " : $ligne[24];
            $ref_parent = empty($ligne[25]) ? " " : $ligne[25];
            $code_maitre = empty($ligne[26]) ? " " : $ligne[26];
            $vte_addi = empty($ligne[27]) ? " " : $ligne[27];
            $ref_fourn = empty($ligne[28]) ? " " : $ligne[28];
            $ref_ac = empty($ligne[29]) ? " " : $ligne[29];
            $ean = empty($ligne[30]) ? " " : $ligne[30];
            $produit = empty($ligne[31]) ? " " : $ligne[31];
            $descr_courte = empty($ligne[32]) ? " " : $ligne[32];
            $descr_longue = empty($ligne[33]) ? " " : $ligne[33];
            $detail_prod = empty($ligne[34]) ? " " : $ligne[34];
            $info_frs = empty($ligne[35]) ? " " : $ligne[35];
            $type_lien = empty($ligne[36]) ? " " : $ligne[36];
            $lien = empty($ligne[37]) ? " " : $ligne[37];
            $triptyque = empty($ligne[38]) ? " " : $ligne[38];
            $quantite = empty($ligne[39]) ? " " : $ligne[39];
            $conditionnement = empty($ligne[40]) ? " " : $ligne[40];
            $delai_livraison = empty($ligne[41]) ? " " : $ligne[41];
            $no_serie = empty($ligne[42]) ? " " : $ligne[42];
            $prix_net = empty($ligne[43]) ? " " : $ligne[43];
            $prix_public = empty($ligne[44]) ? " " : $ligne[44];
            $prix_ca_1 = empty($ligne[45]) ? " " : $ligne[45];
            $prix_vc_1 = empty($ligne[46]) ? " " : $ligne[46];
            $prix_ca_2 = empty($ligne[47]) ? " " : $ligne[47];
            $prix_vc_2 = empty($ligne[48]) ? " " : $ligne[48];
            $prix_ca_3 = empty($ligne[49]) ? " " : $ligne[49];
            $prix_vc_3 = empty($ligne[50]) ? " " : $ligne[50];
            $prix_ca_4 = empty($ligne[51]) ? " " : $ligne[51];
            $prix_vc_4 = empty($ligne[52]) ? " " : $ligne[52];
            $prix_ca_5 = empty($ligne[53]) ? " " : $ligne[53];
            $prix_vc_5 = empty($ligne[54]) ? " " : $ligne[54];
            $degres_qte_1 = empty($ligne[55]) ? " " : $ligne[55];
            $degres_prix_1 = empty($ligne[56]) ? " " : $ligne[56];
            $degres_qte_2 = empty($ligne[57]) ? " " : $ligne[57];
            $degres_prix_2 = empty($ligne[58]) ? " " : $ligne[58];
            $degres_qte_3 = empty($ligne[59]) ? " " : $ligne[59];
            $degres_prix_3 = empty($ligne[60]) ? " " : $ligne[60];
            $degres_qte_4 = empty($ligne[61]) ? " " : $ligne[61];
            $degres_prix_4 = empty($ligne[62]) ? " " : $ligne[62];
            $degres_qte_5 = empty($ligne[63]) ? " " : $ligne[63];
            $degres_prix_5 = empty($ligne[64]) ? " " : $ligne[64];
            $degres_qte_6 = empty($ligne[65]) ? " " : $ligne[65];
            $degres_prix_6 = empty($ligne[66]) ? " " : $ligne[66];
            $degres_qte_7 = empty($ligne[67]) ? " " : $ligne[67];
            $degres_prix_7 = empty($ligne[68]) ? " " : $ligne[68];
            $degres_qte_8 = empty($ligne[69]) ? " " : $ligne[69];
            $degres_prix_8 = empty($ligne[70]) ? " " : $ligne[70];
            $degres_qte_9 = empty($ligne[71]) ? " " : $ligne[71];
            $degres_prix_9 = empty($ligne[72]) ? " " : $ligne[72];
            $degres_qte_10 = empty($ligne[73]) ? " " : $ligne[73];
            $degres_prix_10 = empty($ligne[74]) ? " " : $ligne[74];
            $remise = empty($ligne[75]) ? " " : $ligne[75];
            $photo = empty($ligne[76]) ? " " : $ligne[76];
            $photo_2 = empty($ligne[77]) ? " " : $ligne[77];
            $photo_3 = empty($ligne[78]) ? " " : $ligne[78];
            $pdf_txt_1 = empty($ligne[79]) ? " " : $ligne[79];
            $pdf_lien_1 = empty($ligne[80]) ? " " : $ligne[80];
            $pdf_txt_2 = empty($ligne[81]) ? " " : $ligne[81];
            $pdf_lien_2 = empty($ligne[82]) ? " " : $ligne[82];
            $pdf_txt_3 = empty($ligne[83]) ? " " : $ligne[83];
            $pdf_lien_3 = empty($ligne[84]) ? " " : $ligne[84];
