...
class ProfilsFourn
{
    ...
    /**
     * @var \GccpBundle\Entity\ProfilsUsers
     *
     * @ORM\ManyToOne(targetEntity="GccpBundle\Entity\ProfilsUsers")
     * @ORM\JoinColumns({
     ...
     * Set pu
     *
     * @param \GccpBundle\Entity\ProfilsUsers $pu
     *
     * @return ProfilsFourn
     */
    public function setPu(\GccpBundle\Entity\ProfilsUsers $pu = null)
    {
        $this->pu = $pu;
     ...
     * Get pu
     *
     * @return \GccpBundle\Entity\ProfilsUsers
     */
