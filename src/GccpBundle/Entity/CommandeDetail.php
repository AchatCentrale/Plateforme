...
class CommandeDetail
{
    ...
    /**
     * @var \GccpBundle\Entity\CommandeEntete
     *
     * @ORM\ManyToOne(targetEntity="GccpBundle\Entity\CommandeEntete")
     * @ORM\JoinColumns({
     ...
     * Set ce
     *
     * @param \GccpBundle\Entity\CommandeEntete $ce
     *
     * @return CommandeDetail
     */
    public function setCe(\GccpBundle\Entity\CommandeEntete $ce = null)
    {
        $this->ce = $ce;
     ...
     * Get ce
     *
     * @return \GccpBundle\Entity\CommandeEntete
     */
