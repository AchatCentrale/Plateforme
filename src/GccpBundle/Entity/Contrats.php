...
class Contrats
{
    ...
    /**
     * @var \GccpBundle\Entity\ContratsCat
     *
     * @ORM\ManyToOne(targetEntity="GccpBundle\Entity\ContratsCat")
     * @ORM\JoinColumns({
     ...
     * Set coCategorie
     *
     * @param \GccpBundle\Entity\ContratsCat $coCategorie
     *
     * @return Contrats
     */
    public function setCoCategorie(\GccpBundle\Entity\ContratsCat $coCategorie = null)
    {
     ...
     * Get coCategorie
     *
     * @return \GccpBundle\Entity\ContratsCat
     */
