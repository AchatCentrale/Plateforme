...
class Textes
{
    ...
    /**
     * @var \GccpBundle\Entity\Categories
     *
     * @ORM\ManyToOne(targetEntity="GccpBundle\Entity\Categories")
     * @ORM\JoinColumns({
     ...
     * Set catid
     *
     * @param \GccpBundle\Entity\Categories $catid
     *
     * @return Textes
     */
    public function setCatid(\GccpBundle\Entity\Categories $catid = null)
    {
        $this->catid = $catid;
     ...
     * Get catid
     *
     * @return \GccpBundle\Entity\Categories
     */
