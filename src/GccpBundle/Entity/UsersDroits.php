...
class UsersDroits
{
    ...
    /**
     * @var \GccpBundle\Entity\Users
     *
     * @ORM\ManyToOne(targetEntity="GccpBundle\Entity\Users")
     * @ORM\JoinColumns({
     ...
     * Set us
     *
     * @param \GccpBundle\Entity\Users $us
     *
     * @return UsersDroits
     */
    public function setUs(\GccpBundle\Entity\Users $us = null)
    {
        $this->us = $us;
     ...
     * Get us
     *
     * @return \GccpBundle\Entity\Users
     */
