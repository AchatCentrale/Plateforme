...
class ContratsCat
{
    ...
    /**
     * @var \GccpBundle\Entity\Societes
     *
     * @ORM\ManyToOne(targetEntity="GccpBundle\Entity\Societes")
     * @ORM\JoinColumns({
     ...
     * Set so
     *
     * @param \GccpBundle\Entity\Societes $so
     *
     * @return ContratsCat
     */
    public function setSo(\GccpBundle\Entity\Societes $so = null)
    {
        $this->so = $so;
     ...
     * Get so
     *
     * @return \GccpBundle\Entity\Societes
     */
