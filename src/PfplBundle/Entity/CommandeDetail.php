...
class CommandeDetail
{
    ...
    /**
     * @var \PfplBundle\Entity\CommandeEntete
     *
     * @ORM\ManyToOne(targetEntity="PfplBundle\Entity\CommandeEntete")
     * @ORM\JoinColumns({
     ...
     * Set ce
     *
     * @param \PfplBundle\Entity\CommandeEntete $ce
     *
     * @return CommandeDetail
     */
    public function setCe(\PfplBundle\Entity\CommandeEntete $ce = null)
    {
        $this->ce = $ce;
     ...
     * Get ce
     *
     * @return \PfplBundle\Entity\CommandeEntete
     */
