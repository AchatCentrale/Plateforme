...
class ContratsCat
{
    ...
    /**
     * @var \PfplBundle\Entity\Societes
     *
     * @ORM\ManyToOne(targetEntity="PfplBundle\Entity\Societes")
     * @ORM\JoinColumns({
     ...
     * Set so
     *
     * @param \PfplBundle\Entity\Societes $so
     *
     * @return ContratsCat
     */
    public function setSo(\PfplBundle\Entity\Societes $so = null)
    {
        $this->so = $so;
     ...
     * Get so
     *
     * @return \PfplBundle\Entity\Societes
     */
