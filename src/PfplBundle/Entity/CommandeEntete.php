...
class CommandeEntete
{
    ...
    /**
     * @var \PfplBundle\Entity\MessageEntete
     *
     * @ORM\ManyToOne(targetEntity="PfplBundle\Entity\MessageEntete")
     * @ORM\JoinColumns({
     ...
     * Set me
     *
     * @param \PfplBundle\Entity\MessageEntete $me
     *
     * @return CommandeEntete
     */
    public function setMe(\PfplBundle\Entity\MessageEntete $me = null)
    {
        $this->me = $me;
     ...
     * Get me
     *
     * @return \PfplBundle\Entity\MessageEntete
     */
