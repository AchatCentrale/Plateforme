...
class Textes
{
    ...
    /**
     * @var \PfplBundle\Entity\Categories
     *
     * @ORM\ManyToOne(targetEntity="PfplBundle\Entity\Categories")
     * @ORM\JoinColumns({
     ...
     * Set catid
     *
     * @param \PfplBundle\Entity\Categories $catid
     *
     * @return Textes
     */
    public function setCatid(\PfplBundle\Entity\Categories $catid = null)
    {
        $this->catid = $catid;
     ...
     * Get catid
     *
     * @return \PfplBundle\Entity\Categories
     */
