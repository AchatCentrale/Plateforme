...
class ProfilsFourn
{
    ...
    /**
     * @var \PfplBundle\Entity\ProfilsUsers
     *
     * @ORM\ManyToOne(targetEntity="PfplBundle\Entity\ProfilsUsers")
     * @ORM\JoinColumns({
     ...
     * Set pu
     *
     * @param \PfplBundle\Entity\ProfilsUsers $pu
     *
     * @return ProfilsFourn
     */
    public function setPu(\PfplBundle\Entity\ProfilsUsers $pu = null)
    {
        $this->pu = $pu;
     ...
     * Get pu
     *
     * @return \PfplBundle\Entity\ProfilsUsers
     */
