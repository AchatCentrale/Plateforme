...
class Contrats
{
    ...
    /**
     * @var \PfplBundle\Entity\ContratsCat
     *
     * @ORM\ManyToOne(targetEntity="PfplBundle\Entity\ContratsCat")
     * @ORM\JoinColumns({
     ...
     * Set coCategorie
     *
     * @param \PfplBundle\Entity\ContratsCat $coCategorie
     *
     * @return Contrats
     */
    public function setCoCategorie(\PfplBundle\Entity\ContratsCat $coCategorie = null)
    {
     ...
     * Get coCategorie
     *
     * @return \PfplBundle\Entity\ContratsCat
     */
