...
class CommandeDetail
{
    ...
    /**
     * @var \AchatCentraleBundle\Entity\CommandeEntete
     *
     * @ORM\ManyToOne(targetEntity="AchatCentraleBundle\Entity\CommandeEntete")
     * @ORM\JoinColumns({
     ...
     * Set ce
     *
     * @param \AchatCentraleBundle\Entity\CommandeEntete $ce
     *
     * @return CommandeDetail
     */
    public function setCe(\AchatCentraleBundle\Entity\CommandeEntete $ce = null)
    {
        $this->ce = $ce;
     ...
     * Get ce
     *
     * @return \AchatCentraleBundle\Entity\CommandeEntete
     */
