...
class ProfilsFourn
{
    ...
    /**
     * @var \AchatCentraleBundle\Entity\ProfilsUsers
     *
     * @ORM\ManyToOne(targetEntity="AchatCentraleBundle\Entity\ProfilsUsers")
     * @ORM\JoinColumns({
     ...
     * Set pu
     *
     * @param \AchatCentraleBundle\Entity\ProfilsUsers $pu
     *
     * @return ProfilsFourn
     */
    public function setPu(\AchatCentraleBundle\Entity\ProfilsUsers $pu = null)
    {
        $this->pu = $pu;
     ...
     * Get pu
     *
     * @return \AchatCentraleBundle\Entity\ProfilsUsers
     */
