...
class Contrats
{
    ...
    /**
     * @var \AchatCentraleBundle\Entity\ContratsCat
     *
     * @ORM\ManyToOne(targetEntity="AchatCentraleBundle\Entity\ContratsCat")
     * @ORM\JoinColumns({
     ...
     * Set coCategorie
     *
     * @param \AchatCentraleBundle\Entity\ContratsCat $coCategorie
     *
     * @return Contrats
     */
    public function setCoCategorie(\AchatCentraleBundle\Entity\ContratsCat $coCategorie = null)
    {
     ...
     * Get coCategorie
     *
     * @return \AchatCentraleBundle\Entity\ContratsCat
     */
