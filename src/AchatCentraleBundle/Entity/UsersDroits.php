...
class UsersDroits
{
    ...
    /**
     * @var \AchatCentraleBundle\Entity\Users
     *
     * @ORM\ManyToOne(targetEntity="AchatCentraleBundle\Entity\Users")
     * @ORM\JoinColumns({
     ...
     * Set us
     *
     * @param \AchatCentraleBundle\Entity\Users $us
     *
     * @return UsersDroits
     */
    public function setUs(\AchatCentraleBundle\Entity\Users $us = null)
    {
        $this->us = $us;
     ...
     * Get us
     *
     * @return \AchatCentraleBundle\Entity\Users
     */
