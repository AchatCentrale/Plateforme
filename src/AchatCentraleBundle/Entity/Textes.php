...
class Textes
{
    ...
    /**
     * @var \AchatCentraleBundle\Entity\Categories
     *
     * @ORM\ManyToOne(targetEntity="AchatCentraleBundle\Entity\Categories")
     * @ORM\JoinColumns({
     ...
     * Set catid
     *
     * @param \AchatCentraleBundle\Entity\Categories $catid
     *
     * @return Textes
     */
    public function setCatid(\AchatCentraleBundle\Entity\Categories $catid = null)
    {
        $this->catid = $catid;
     ...
     * Get catid
     *
     * @return \AchatCentraleBundle\Entity\Categories
     */
