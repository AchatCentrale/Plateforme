...
class ContratsCat
{
    ...
    /**
     * @var \AchatCentraleBundle\Entity\Societes
     *
     * @ORM\ManyToOne(targetEntity="AchatCentraleBundle\Entity\Societes")
     * @ORM\JoinColumns({
     ...
     * Set so
     *
     * @param \AchatCentraleBundle\Entity\Societes $so
     *
     * @return ContratsCat
     */
    public function setSo(\AchatCentraleBundle\Entity\Societes $so = null)
    {
        $this->so = $so;
     ...
     * Get so
     *
     * @return \AchatCentraleBundle\Entity\Societes
     */
